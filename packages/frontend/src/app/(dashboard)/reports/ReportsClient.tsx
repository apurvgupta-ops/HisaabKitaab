...
function ChartSkeleton() {
  return (
    <Card className="animate-pulse">
      ...
      <CardContent>
        <div className="bg-muted/50 h-[300px] w-full rounded" />
      </CardContent>
    </Card>
  );
}
...
export default function ReportsPage() {
  ...
  const topCategories = useMemo(() => categoryData.slice(0, 8), [categoryData]);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Analyze your financial data and trends</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-4">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-muted-foreground text-sm font-medium">Net</CardTitle>
