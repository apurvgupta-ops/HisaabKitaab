  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <Card>
          {/* Table Header */}
          <div className="hidden items-center gap-4 border-b bg-muted/50 px-4 py-3 text-xs font-medium uppercase tracking-wider text-muted-foreground sm:flex">
          ...
          <div className="divide-y">
            {transactions.map((tx) => {
              ...
              return (
                <div
                  key={tx.id}
                  className="flex flex-col gap-2 px-4 py-3 transition-colors hover:bg-muted/30 sm:flex-row sm:items-center sm:gap-4"
                >
